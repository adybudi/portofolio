            ...
            <div>
                ...
                <nav class="p-4 space-y-1 text-xs font-extrabold uppercase tracking-wider">
                    ...
                    <a href="{{ route('profile.edit') }}" 
                       class="flex items-center gap-3 px-4 py-2.5 border-l-4 transition-all {{ request()->routeIs('profile.*') ? 'border-[#0096c7] bg-[#f0f9ff] dark:bg-[#0096c7]/15 text-[#0096c7]' : 'border-transparent text-subtext hover:bg-slate-100 dark:hover:bg-slate-800/60 hover:text-heading' }}">
                ...
                <div class="flex items-center gap-4" x-data="{ 
                    ...
                    <div class="dropdown dropdown-end">
                        ...
                        <ul tabindex="0" class="mt-3 z-[1] p-2 shadow-2xl menu menu-sm dropdown-content bg-white dark:bg-[#131924] border border-slate-200 dark:border-slate-800 rounded-none w-56 space-y-1 text-current">
                            ...
                            <li>
                                <a href="{{ route('profile.edit') }}" class="hover:text-[#0096c7] text-xs font-bold uppercase">Ubah Password & Akun</a>
                            </li>
                            <li>
