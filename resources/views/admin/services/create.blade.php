    ...
    <div class="max-w-3xl">
        ...
        <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" required class="input-theme w-full" placeholder="cth. Jasa Pembuatan Website Laravel">
            ...
            <div>
                ...
                <textarea name="description" rows="4" class="input-theme w-full resize-none" placeholder="Deskripsikan layanan yang ditawarkan...">{{ old('description') }}</textarea>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="price" value="{{ old('price') }}" min="0" step="1000" class="input-theme w-full" placeholder="cth. 1500000">
                ...
                <div>
                    ...
                    <input type="number" name="discount_price" value="{{ old('discount_price') }}" min="0" step="1000" class="input-theme w-full" placeholder="cth. 1200000">
                ...
                <div class="space-y-2">
                    <template x-for="(feature, index) in features" :key="index">
                        <div class="flex items-center gap-2">
                            <input type="text" :name="'features[' + index + ']'" x-model="features[index]" class="input-theme flex-1" placeholder="cth. Desain responsif & mobile-friendly">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="order" value="{{ old('order', 0) }}" min="0" class="input-theme w-full">
